 ...
 * displayed entries in the popup is defined by {@link #maxEntries maxEntries}.
 ...
 * auto.setPopupHidden(true); SimpleListProperty filteredEntries = new
 * SimpleListProperty(auto.getFilteredEntries());
...
public class AutoCompleteTextField<S> extends TextField {
    ...
    /**
     * The maximum Number of entries displayed in the popup. Default: 10
     */
